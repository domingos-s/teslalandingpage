const tabs = [
  { key: 'world-politics', label: 'World Politics', query: 'global diplomacy elections conflict', keywords: ['world','geopolitics','diplomacy','war','un','nato','foreign policy','election'], rss: ['https://feeds.bbci.co.uk/news/world/rss.xml','https://www.aljazeera.com/xml/rss/all.xml','https://www.dw.com/en/top-stories/s-9097/rss','https://rss.nytimes.com/services/xml/rss/nyt/World.xml','https://www.theguardian.com/world/rss','https://www.france24.com/en/rss','https://www.euronews.com/rss?level=theme&name=world'] },
  { key: 'us-politics', label: 'U.S. Politics', query: 'US congress white house election policy', keywords: ['u.s.','united states','congress','senate','house','white house','supreme court','governor','election','democrat','republican'], rss: ['https://rss.politico.com/politics-news.xml','https://feeds.npr.org/1014/rss.xml','https://rss.nytimes.com/services/xml/rss/nyt/US.xml','https://www.theguardian.com/us-news/rss','https://www.cbsnews.com/latest/rss/politics','https://www.voanews.com/api/zyireq$yqm','https://rss.nytimes.com/services/xml/rss/nyt/Politics.xml'] },
  { key: 'business', label: 'Business', query: 'markets economy business finance', keywords: ['market','economy','business','finance','stocks','earnings','inflation','federal reserve','nasdaq','dow'], rss: ['https://www.cnbc.com/id/10001147/device/rss/rss.html','https://feeds.a.dj.com/rss/RSSMarketsMain.xml','https://rss.nytimes.com/services/xml/rss/nyt/Business.xml','https://www.ft.com/rss/home/us','https://www.theguardian.com/business/rss','https://www.marketwatch.com/rss/topstories','https://www.forbes.com/business/feed/'] },
  { key: 'technology', label: 'Technology', query: 'technology AI software chips cybersecurity', keywords: ['technology','ai','software','chip','cyber','apple','google','microsoft','startup','openai'], rss: ['https://www.theverge.com/rss/index.xml','https://feeds.arstechnica.com/arstechnica/technology-lab','https://rss.nytimes.com/services/xml/rss/nyt/Technology.xml','https://techcrunch.com/feed/','https://www.wired.com/feed/rss','https://www.engadget.com/rss.xml','https://www.zdnet.com/news/rss.xml'] },
  { key: 'entertainment', label: 'Entertainment', query: 'movies television music celebrities entertainment', keywords: ['movie','film','tv','series','music','celebrity','entertainment','netflix','hollywood'], rss: ['https://www.billboard.com/feed/','https://variety.com/feed/','https://www.hollywoodreporter.com/feed/','https://rss.nytimes.com/services/xml/rss/nyt/Arts.xml','https://www.rollingstone.com/music/music-news/feed/','https://pitchfork.com/rss/news/'] },
  { key: 'sports', label: 'Sports', query: 'sports nfl nba mlb soccer tennis olympics', keywords: ['sports','nfl','nba','mlb','nhl','soccer','football','tennis','golf','olympic'], rss: ['https://www.espn.com/espn/rss/news','https://sports.yahoo.com/rss/','https://www.skysports.com/rss/12040','https://rss.nytimes.com/services/xml/rss/nyt/Sports.xml','https://www.cbssports.com/rss/headlines/','https://talksport.com/feed/'] },
  { key: 'science', label: 'Science', query: 'science research space climate discovery physics', keywords: ['science','research','study','space','nasa','climate','biology','physics','chemistry'], rss: ['https://www.sciencedaily.com/rss/all.xml','https://www.nasa.gov/news-release/feed/','https://www.sciencemag.org/rss/news_current.xml','https://rss.nytimes.com/services/xml/rss/nyt/Science.xml','https://phys.org/rss-feed/','https://www.newscientist.com/feed/home/'] },
  { key: 'health', label: 'Health', query: 'health medicine public health disease wellness', keywords: ['health','medical','medicine','disease','wellness','hospital','doctor','mental health','covid'], rss: ['https://www.medicalnewstoday.com/rss','https://www.cdc.gov/rss/cdc.xml','https://rss.nytimes.com/services/xml/rss/nyt/Health.xml','https://www.who.int/feeds/entity/csr/don/en/rss.xml','https://www.nih.gov/news-events/news-releases/feed','https://www.healthline.com/health-news/feed'] }
]
